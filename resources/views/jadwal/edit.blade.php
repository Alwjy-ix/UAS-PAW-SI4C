...
<div class="bengkel-page-header">
    <div>
        <h2 class="page-heading">Edit Jadwal</h2>
        <p class="page-subheading">Perbarui jadwal shift mekanik</p>
    </div>
...
<div class="bengkel-panel form-panel">
    <form method="POST" action="{{ route('jadwal.update', $jadwal) }}" class="bengkel-form" id="formEditJadwal">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <select name="mekanik_id" id="mekanik_id" class="form-control @error('mekanik_id') is-invalid @enderror" required>
                ...
                <option value="{{ $mek->id }}" {{ old('mekanik_id', $jadwal->mekanik_id) == $mek->id ? 'selected' : '' }}>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <select name="status" id="status" class="form-control @error('status') is-invalid @enderror" required>
                    ...
                    <option value="izin"  {{ old('status', $jadwal->status) === 'izin'  ? 'selected' : '' }}>🟡 Izin</option>
                </select>
        ...
        <div class="form-group">
            ...
            <input type="text" name="keterangan" id="keterangan"
                ...
                value="{{ old('keterangan', $jadwal->keterangan) }}" placeholder="Keterangan tambahan...">
