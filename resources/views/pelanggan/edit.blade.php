...
<div class="bengkel-page-header">
    <div>
        <h2 class="page-heading">Edit Pelanggan</h2>
        <p class="page-subheading">Perbarui data pelanggan <strong>{{ $pelanggan->nama }}</strong></p>
    </div>
...
<div class="bengkel-panel form-panel">
    <form method="POST" action="{{ route('pelanggan.update', $pelanggan) }}" class="bengkel-form" id="formEditPelanggan">
        @csrf
        @method('PUT')
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror"
                    value="{{ old('nama', $pelanggan->nama) }}" placeholder="Nama lengkap" required>
            ...
            <div class="form-group">
                ...
                <input type="text" name="no_ktp" id="no_ktp" class="form-control @error('no_ktp') is-invalid @enderror"
                    value="{{ old('no_ktp', $pelanggan->no_ktp) }}" placeholder="NIK 16 digit" minlength="16" maxlength="16">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="no_hp" id="no_hp" class="form-control @error('no_hp') is-invalid @enderror"
                    value="{{ old('no_hp', $pelanggan->no_hp) }}" placeholder="No. HP" required>
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror"
                    value="{{ old('email', $pelanggan->email) }}" placeholder="Email pelanggan">
